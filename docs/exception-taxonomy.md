...
| `AR-004` | HIGH | `stated_total` ≠ `subtotal + tax + Σ additional_charges` | Diff > $0.01. Include `additional_charges` or INV-1010's $150 shipping produces a false finding. | INV-1013 (+$50 grand-total error) |
